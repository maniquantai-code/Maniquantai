...
from .routers import (llm_router,chat_router,strategies_router,pipeline_router,wallet_router,broker_accounts_router,mt5_bridge_router)
...
app.include_router(llm_router);app.include_router(chat_router);app.include_router(strategies_router);app.include_router(pipeline_router);app.include_router(wallet_router);app.include_router(broker_accounts_router);app.include_router(mt5_bridge_router)
@app.get("/")
